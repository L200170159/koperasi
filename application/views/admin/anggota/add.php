        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url('admin/anggota/add') ?>" class="form-horizontal" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="_NIK_" class="col-sm-3 col-form-label" style="text-align: right;">NIK</label>
                    <div class="col-sm-6">
                      <input type="text" name="_NIK_" class="form-control" id="_NIK_" placeholder="NIK" value="<?php echo set_value('_NIK_'); ?>" required="required">
                    </div>
                  </div>
