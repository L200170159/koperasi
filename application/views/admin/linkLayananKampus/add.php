  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Link Layanan Kampus</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url('admin/linkLayananKampus/add') ?>" class="form-horizontal" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="_Nama_" class="col-sm-3 col-form-label" style="text-align: right;">Nama</label>
                    <div class="col-sm-6">
                      <input type="text" name="_Nama_" class="form-control" id="_Nama_" placeholder="Nama" value="<?php echo set_value('_Nama_'); ?>" required="required">
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="_Link_" class="col-sm-3 col-form-label" style="text-align: right;">Link</label>
                    <div class="col-sm-6">
                      <input type="text" name="_Link_" class="form-control" id="_Link_" placeholder="Link" value="<?php echo set_value('_Link_'); ?>" required="required">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
