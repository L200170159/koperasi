        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url('admin/tentangkami/add') ?>" class="form-horizontal" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="_judul_">Judul</label>
                    <div class="col-lg">
                      <input type="text" name="_judul_" class="form-control" id="_judul_" placeholder="Judul" value="<?php echo set_value('_judul_'); ?>" required="required">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg">
                        <textarea class="form-control col" id="_deskripsi_" name="_deskripsi_" style="height: 200px;" required></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
