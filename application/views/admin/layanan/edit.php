        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url('admin/layanan/edit/'.$encrypt_id) ?>" class="form-horizontal" method="post">
                <div class="card-body">
                    <div class="form-group">
                        <label for="_namalayanan_">Nama Lyanan</label>
                        <div class="col-lg">
                        <input type="text" name="_namalayanan_" class="form-control" id="_namalayanan_" placeholder="Nama Layanan" value="<?php if (set_value('_name_') != null) { echo set_value('_name_'); } else { echo $layanan['nama_layanan']; } ?>" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg">
                            <textarea class="form-control col" id="_deskripsi_" name="_deskripsi_" style="height: 200px;" required><?= $layanan['isi']?></textarea>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
